 ...
 * width is undefined. */
std::string* Schema::row_name(size_t idx) { return __rowNames.at(idx); }

/** Return name of column at idx; nullptr indicates no name given.
 *  An idx >= width is undefined.*/
std::string* Schema::col_name(size_t idx) { return __colNames.at(idx); }

/** Return type of column at idx. An idx >= width is undefined. */
char Schema::col_type(size_t idx) { return __colTypes.at(idx); }
...
size_t Schema::width() { return __colNames.size(); }

/** The number of rows */
size_t Schema::length() { return __rowNames.size(); }